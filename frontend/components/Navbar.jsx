...
import SplitMenu from './ui/SplitMenu';
import AudioMenu from './ui/AudioMenu';
  ...
  const contentMap = {
    ...
    'Video': (
      <div className="space-y-6">
        ...
        <button className="flex flex-col items-center p-4 bg-gray-400 hover:bg-gray-500 transition-all duration-300 text-white rounded-md w-full mb-4">
