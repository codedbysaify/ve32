...
const handleDragStart=(url,type,name,e)=>{
  ...
  return (
    ...
    <div
  className={`${
    mediaFile ? 'border-blue-400' : 'border-2'
  } border-2 hover:bg-gray-500  hover:te flex flex-col justify-center items-center rounded-[15px] w-[200px] h-[100px] overflow-hidden cursor-pointer relative`}
  ...
  {mediaFile ? (
    ...
    <div className="flex items-center justify-center w-full h-full text-gray-400">
      ...
      <p className="text-xs text-center">
        There is nothing yet.<br />Click here to upload.
      </p>
    </div>
  )}
</div>
  ...
  <div className="flex justify-center items-center h-[100px]">
    ...
    <div className="flex flex-col gap-2 mt-2">
      {recentUploads.map((upload, index) => (
        <div key={index} 
        className="w-[200px] h-[100px] rounded-[15px] overflow-hidden relative">
          {upload.type.startsWith('image/') && (
            <img
              ...
              onDragStart={(e)=>handleDragStart(upload.url,upload.type,upload.name,e)}
              draggable={true}
            />
          )}
